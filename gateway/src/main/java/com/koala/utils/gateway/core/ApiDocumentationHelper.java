...
import com.koala.utils.gateway.annotation.EnumDef;
import com.koala.utils.gateway.define.CommonParameter;
import com.koala.utils.gateway.document.*;
import com.koala.utils.gateway.entity.AbstractReturnCode;
import com.koala.utils.gateway.entity.ApiMethodInfo;
import com.koala.utils.gateway.entity.ApiParameterInfo;
import com.koala.utils.gateway.entity.ReturnCodeContainer;
import com.koala.utils.gateway.responseEntity.*;
...
public class ApiDocumentationHelper {
    ...
    private RespStruct buildVirtualListStruct(String groupName, Class<?> clazz) {
        ...
        if (!clazz.getName().startsWith("com.ulife.common.gateway.utils.")) {
    ...
    private String getEntityName(String group, Class<?> type) {
        return (group == null || group.length() == 0 || type.getName().startsWith(
                "com.ulife.common.gateway.utils.")) ? "Api_" + type.getSimpleName() : "Api_" + group.toUpperCase() + "_" + type.getSimpleName();
    }

    private String getEntityName4CollectionAndArray(String group, Class<?> type) {
        return (group == null || group.length() == 0 || type.getName().startsWith(
                "com.ulife.common.gateway.utils.")) ? "Api_" + type.getSimpleName() + "_ArrayResp" : "Api_" + group.toUpperCase() + "_" + type.getSimpleName() + "_ArrayResp";
    }
